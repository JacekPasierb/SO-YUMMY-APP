...
const MyRecipesPage = () => {
    ...
    return (_jsxs("main", { className: css.background, children: [_jsx(Header, {}), _jsxs("div", { className: `${css.container} ${css.flex}`, children: [_jsx(MainTitle, { title: "My recipes" }), isLoading ? (_jsx("div", { className: css.boxLoader, children: _jsx(ClimbingBoxLoader, {}) })) : (_jsxs(_Fragment, { children: [_jsx(MyRecipesList, { recipes: ownRecipes }), _jsx(BasicPagination, { count: Math.ceil(totalOwnRecipes / 4), page: currentPage, onPageChange: handlePageChange })] }))] })] }));
};
