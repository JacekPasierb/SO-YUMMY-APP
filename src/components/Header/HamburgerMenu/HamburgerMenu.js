...
const HamburgerMenu = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("img", { src: menu, alt: "menu Ikona", width: "40", height: "40", onClick: handleMenuModalClick, className: css.menuIcon }), isMenuModalOpen && (_jsx(Suspense, { fallback: _jsx("div", { children: "Loading..." }), children: _jsx(MenuModal, { onClose: handleMenuModalClick }) }))] }));
};
