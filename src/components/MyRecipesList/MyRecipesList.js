...
const MyRecipesList = () => {
    ...
    return (_jsx(_Fragment, { children: isLoading ? (_jsx("p", { children: "Loading recipes..." })) : (ownRecipes && (_jsx("ul", { className: css.myRecipesList, children: ownRecipes.map((ownRecipe) => {
