...
const RecipePreparation = ({ img, instructions, }) => {
    ...
    return (_jsxs("div", { className: `${css.container} ${css.flex}`, children: [_jsxs("div", { children: [_jsx(SubTitle, { title: "Recipe Preparation" }), _jsx("ul", { className: css.instructionsList, children: step &&
